# -*- coding: utf-8 -*-
"""
Created on Fri May 27 20:47:26 2022
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, tgt_pos=None, tgt_layer=None, tmp_score=None, tgt_label=None, imp_pos=None, imp_op=None):
        ...
        if imp_op == 'return':
            ...
            if tmp_score is None:
                ...
                gradient = torch.autograd.grad(torch.unbind(tgt_prob[:, tgt_label]), tmp_score) #Simple gradient calculation (torch does it for us)
				#torch.autograd.grad seems unbelivably useful
